        ...
        <section className="bg-[#001933] w-screen">
            ...
            <header className="w-full h-[70px] flex">
                ...
                <div className="w-[80%] h-full flex justify-around items-center">
                    ...
                    <Link href="/details" className="text-[#00fdff] font-bold font-[fontSite] hover:border-b-2 hover:border-[#00fdff] italic">Details</Link>
                </div>
            ...
            <footer className="w-full h-[195px] bg-[#007f8e] flex justify-center items-center flex-col">
                ...
                <div>
                    <p className="text-[#00fdff] font-[fontSite] italic">Hello world, this is the footer</p>
                </div>

                <div>
                    <p className="font-[fontSite] italic">Bruh</p>
                </div>
